...
WCHAR szTitle[MAX_LOADSTRING] = L"VmEngineStudy";
WCHAR szWindowClass[MAX_LOADSTRING] = L"VmEngineStudy";
HINSTANCE g_hInstance;
HWND g_hWnd;
const int g_nWindowWidth = 800;
const int g_nWindowHeight = 600;
VmFramework g_VmFramework;
	...
	_In_ int       nCmdShow)
{
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_VMENGINE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_VMENGINE));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{
	case WM_KEYDOWN:
		g_VmFramework.CameraMove(wParam);
		break;
	case WM_COMMAND:
	{
